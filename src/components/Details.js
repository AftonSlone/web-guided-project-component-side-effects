...
export default function Details(props) {
  ...
  useEffect(() => {
    console.log(`EFFECT ONLY AFTER FIRST RENDER`);
    return () => {
      console.log(`CLEANIP RIGHT BEFORE COMPONENT IS REMOVED`);
    };
  }, []);
  ...
  useEffect(() => {
    console.log(`Runs after first rendar + all others too`);
    return () => {
      console.log(
        `cleanup after the effect of the Previous rendor of the component`
      );
    };
  }, []);
